Return-Path: <bounce+16102+100+1808289+3934443@groups.io>
X-Original-To: lists+linux-oxnas@lfdr.de
Delivered-To: lists+linux-oxnas@lfdr.de
Received: from mail02.groups.io (mail02.groups.io [66.175.222.108])
	by mail.lfdr.de (Postfix) with ESMTPS id E2A74365B66
	for <lists+linux-oxnas@lfdr.de>; Tue, 20 Apr 2021 16:45:34 +0200 (CEST)
X-Received: by 127.0.0.2 with SMTP id 2NTbYY1809624xedo89Xg7n3; Tue, 20 Apr 2021 07:45:33 -0700
X-Received: from ssl.serverraum.org (ssl.serverraum.org [176.9.125.105])
 by mx.groups.io with SMTP id smtpd.web09.702.1618249667023478908
 for <linux-oxnas@groups.io>;
 Mon, 12 Apr 2021 10:47:47 -0700
...
Subject: [linux-oxnas] [PATCH net-next v4 1/2] of: net: pass the dst buffer to of_get_mac_address()
...
X-Gm-Message-State: 87fULkDIHNV3Oc0gkdO0inEVx1808289AA=
Content-Transfer-Encoding: quoted-printable
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=groups.io;
 q=dns/txt; s=20140610; t=1618929933;
 bh=qKth/YJoCj+j+BNo/aKlEQGffcZe0AO/zL8cr75VZJ8=;
 h=Cc:Date:From:Reply-To:Subject:To;
 b=UyS5V/UzjF7GZxdPoCj7j4K+8YzLFPvHtq4qblZhOpQY6Mk2TNNcACoBcqKDvAr0Pam
 upQAtPwo3or+JREWLycXZcsgMqU5PvBsFDMRvCZ8Cb5UMfCA9DxXVFmFaAiNNY9opV64M
 S7N5DZ03I0T+HI3pDAjxK/fucaIrJVeFEA8=
...
@@ -686,7 +686,6 @@ static int bcm4908_enet_probe(struct platform_device =
*pdev)
...
@@ -716,10 +715,8 @@ static int bcm4908_enet_probe(struct platform_device=
 *pdev)
 		return err;
=20
...
-	const char *mac;
 	...
 	int err, val;
=20
@@ -4764,15 +4763,11 @@ static int macb_probe(struct platform_device *pde=
v)
...
@@ -640,7 +640,6 @@ static phy_interface_t gfar_get_interface(struct net_=
device *dev)
...
@@ -782,11 +781,8 @@ static int gfar_of_init(struct platform_device *ofde=
...
@@ -438,7 +438,7 @@ static void temac_do_set_mac_address(struct net_devic=
e *ndev)
=20
 static int temac_init_mac_address(struct net_device *ndev, const void *a=
ddress)
 {
...
View/Reply Online (#100): https://groups.io/g/linux-oxnas/message/100
Mute This Topic: https://groups.io/mt/82236154/1808289
