Return-Path: <bounce+16102+316+1808289+3934443@groups.io>
X-Original-To: lists+linux-oxnas@lfdr.de
Delivered-To: lists+linux-oxnas@lfdr.de
Received: from mail02.groups.io (mail02.groups.io [66.175.222.108])
	by mail.lfdr.de (Postfix) with ESMTPS id 4935677B3B0
	for <lists+linux-oxnas@lfdr.de>; Mon, 14 Aug 2023 10:16:50 +0200 (CEST)
DKIM-Signature: a=rsa-sha256; bh=i6HTttFFrF24k6pRmCLJ+g4Z2uAoTj9sKAQulUgp/9Y=;
 ...
 s=20140610; t=1692001008; v=1;
 b=jUieWaOlfcAgJU8UUqM+SP8FNr7yCaFq17uTG2fauTRW0d4v/GXm+/zKCMriv+9iTp/kPTfP
 OdsNLC9n9J2SvSbsIP/L/zM3QT4Yr/B/KXk2bPQF1gXcmNoZke8e2aG6yy80+YUms7t4rXXHncU
 fGLHlbFlBKM4mshX6xuyhvAs=
X-Received: by 127.0.0.2 with SMTP id oUZlYY1809624xoNCGh6ZCek; Mon, 14 Aug 2023 01:16:48 -0700
X-Received: from mail-wr1-f50.google.com (mail-wr1-f50.google.com [209.85.221.50])
 by mx.groups.io with SMTP id smtpd.web11.102963.1692001008184319854
 for <linux-oxnas@groups.io>;
 Mon, 14 Aug 2023 01:16:48 -0700
X-Received: by mail-wr1-f50.google.com with SMTP id ffacd0b85a97d-307d20548adso3633684f8f.0
        for <linux-oxnas@groups.io>; Mon, 14 Aug 2023 01:16:47 -0700 (PDT)
X-Gm-Message-State: vXqmdaVTnsFhodJW4tDTgkbfx1808289AA=
...
Subject: [linux-oxnas] [PATCH v3 1/3] pinctrl: pinctrl-oxnas: remove obsolete pinctrl driver
MIME-Version: 1.0
...
diff --git a/drivers/pinctrl/pinctrl-oxnas.c b/drivers/pinctrl/pinctrl-oxna=
s.c
...
-};
-
-static inline struct oxnas_gpio_bank *pctl_to_bank(struct oxnas_pinctrl *p=
ctl,
-						   unsigned int pin)
-{
...
-}
-
-static const char *oxnas_pinctrl_get_group_name(struct pinctrl_dev *pctlde=
v,
-						unsigned int group)
-{
-	struct oxnas_pinctrl *pctl =3D pinctrl_dev_get_drvdata(pctldev);
...
-
-static const char *
-oxnas_pinmux_get_function_name(struct pinctrl_dev *pctldev, unsigned int f=
unc)
-{
-	struct oxnas_pinctrl *pctl =3D pinctrl_dev_get_drvdata(pctldev);
-
...
-}
-
-static int oxnas_gpio_irq_set_type(struct irq_data *data, unsigned int typ=
e)
-{
...
View/Reply Online (#316): https://groups.io/g/linux-oxnas/message/316
Mute This Topic: https://groups.io/mt/100732979/1808289
